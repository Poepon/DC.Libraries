...
namespace DC.Libraries.Extensions.Captcha.CoreFx
{
    /// <summary>
    ...
    public static class ColorTranslator
    {
        ...
        public static Color FromHtml(string htmlColor)
        {
            ...
            throw new NotSupportedException($"Please change the `{htmlColor}` color. Only Hex Colors (#RRGGBB or #RGB) Are Supported.");
        }
    }
}